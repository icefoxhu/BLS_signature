...
def createParser():
	...
	Аргументы:
		...
		Основные параметры:
			...
			-p {SS512,SS1024,MNT159,MNT201,MNT224},			
			--params {SS512,SS1024,MNT159,MNT201,MNT224}
	...
	parser = argparse.ArgumentParser(
		prog = 'ЭЦП БЛС',
		description = 'Данная программа является реализацией асимметричной криптосхемы 
		Боне-Линна-Шахема на основе парных отображений.',
